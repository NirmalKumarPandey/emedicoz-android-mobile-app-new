...
public class ShadowContainerView extends FrameLayout {
    ...
    public ShadowContainerView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public ShadowContainerView(Context context, AttributeSet attrs, int defStyleAttr) {
        this(context, attrs, defStyleAttr, 0);
    }

    public ShadowContainerView(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        super(context, attrs, defStyleAttr);

        final TypedArray ta = context.obtainStyledAttributes(attrs, R.styleable.ms9_ShadowContainerView, defStyleAttr, defStyleRes);
        final float shadowTranslationZ = ta.getDimension(R.styleable.ms9_ShadowContainerView_ms9_shadowTranslationZ, mShadowTranslationZ);
        final float shadowElevation = ta.getDimension(R.styleable.ms9_ShadowContainerView_ms9_shadowElevation, mShadowElevation);
        final int spotShadowLevelListResId = ta.getResourceId(R.styleable.ms9_ShadowContainerView_ms9_spotShadowDrawablesList, 0);
        final int ambientShadowLevelListResId = ta.getResourceId(R.styleable.ms9_ShadowContainerView_ms9_ambientShadowDrawablesList, 0);
        final boolean forceUseCompatShadow = ta.getBoolean(R.styleable.ms9_ShadowContainerView_ms9_forceUseCompatShadow, mForceUseCompatShadow);
        final boolean affectsXYPosition = ta.getBoolean(R.styleable.ms9_ShadowContainerView_ms9_affectsDisplayedPosition, mAffectsDisplayedPosition);
        final boolean useAmbientShadow = ta.getBoolean(R.styleable.ms9_ShadowContainerView_ms9_useAmbientShadow, mUseAmbientShadow);
        final boolean useSpotShadow = ta.getBoolean(R.styleable.ms9_ShadowContainerView_ms9_useSpotShadow, mUseSpotShadow);
        ta.recycle();
