...
public class LeaderBoardFragment extends Fragment implements View.OnClickListener, MyNetworkCall.MyNetworkCallBack {
    ...
    Progress mprogress;
    RankList rankList;
    ArrayList<RankList> arrayList, newArrayList;
    ...
    public static LeaderBoardFragment newInstance(String fragType, String status, ResultTestSeries resultTestSeries) {
    ...
    private void initViews(View view) {
        ...
        totalQues.setText("Total questions: " + resultTestSeries.getTotalQuestions());
        totalTime.setText("Total time: " + resultTestSeries.getTotalTestSeriesTime() + " mins");
    ...
    private void setTopThreeDetail(ArrayList<RankList> arrayList) {
        ...
        if (arrayList.size() == 1) {
            ...
            firstTotal.setText("out of " + totalMarks);
            ...
            secondTotal.setText("out of " + totalMarks);
            ...
            thirdTotal.setText("out of " + totalMarks);
    ...
    public void netoworkCallForRank() {
        myNetworkCall.NetworkAPICall(API.API_GET_RANK_LIST, true);
    }
    ...
    public Call<JsonObject> getAPI(String apiType, FlashCardApiInterface service) {
        ...
        params.put("test_series_id", resultTestSeries.getTestSeriesId());
