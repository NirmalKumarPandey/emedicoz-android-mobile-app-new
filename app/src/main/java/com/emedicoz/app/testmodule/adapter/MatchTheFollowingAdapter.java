...
public class MatchTheFollowingAdapter extends RecyclerView.Adapter<MatchTheFollowingAdapter.MatchTheFollowingViewHolder> {
    ...
    AdapterMatchingOption adapterMatchingOption;
    ...
    public MatchTheFollowingAdapter(Activity activity, ArrayList<Social> items1, ArrayList<Social> items2, boolean isTest, int pagerPosition) {
    ...
    public MatchTheFollowingAdapter(Activity activity, ArrayList<Social> items1, ArrayList<Social> items2, boolean isTest, int pagerPosition, ArrayList<String> answerList, ArrayList<String> userAnswerList) {
        this.activity = activity;
        this.items1 = items1;
        this.items2 = items2;
        this.isTest = isTest;
    ...
    public MatchTheFollowingAdapter(Activity activity, ArrayList<Social> items1, ArrayList<Social> items2, boolean isTest, int pagerPosition, ArrayList<String> answerList) {
        this.activity = activity;
        this.items1 = items1;
        this.items2 = items2;
        this.isTest = isTest;
    ...
    public void onBindViewHolder(@NonNull MatchTheFollowingViewHolder holder, int position) {
        ...
        Log.e("onBindViewHolder: ", items1.get(position).getName());
        ...
        if (isTest) {
            adapterMatchingOption = new AdapterMatchingOption(activity, items2, items1, position, pagerPosition);
            holder.checkRV.setAdapter(adapterMatchingOption);
        } else {
            adapterMatchingOptionViewSolution = new AdapterMatchingOptionViewSolution(activity, items2, items1, position, pagerPosition, answerList, userAnswerList);
            holder.checkRV.setAdapter(adapterMatchingOptionViewSolution);
        }
