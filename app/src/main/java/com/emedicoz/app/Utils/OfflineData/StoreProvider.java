...
// Keep it in this package only, It is on LIVE project
...
public class StoreProvider extends ContentProvider {
    ...
    // Fore more info, look into checklist.txt point-2
    public static String eMedicoz_AUTHORITY = BuildConfig.APPLICATION_ID + ".utils.OfflineData.StoreProvider";
