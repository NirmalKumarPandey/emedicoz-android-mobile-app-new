...
public class Registration implements Serializable {
    ...
    public String toString() {
        return "Registration{" +
                ...
                ", master_id='" + master_id + '\'' +
                ", master_id_level_one='" + master_id_level_one + '\'' +
                ", master_id_level_two='" + master_id_level_two + '\'' +
                ", optional_text='" + optional_text + '\'' +
                ", master_id_name='" + master_id_name + '\'' +
                ", master_id_level_one_name='" + master_id_level_one_name + '\'' +
                ", master_id_level_two_name='" + master_id_level_two_name + '\'' +
                ", interested_course_text='" + interested_course_text + '\'' +
