...
public class CourseCatTile implements Serializable {
    ...
    @SerializedName("data")
    @Expose
    private ArrayList<CourseCatTileData> data = null;
    ...
    public ArrayList<CourseCatTileData> getData() {
        return data;
    }

    public void setData(ArrayList<CourseCatTileData> data) {
        this.data = data;
    }
