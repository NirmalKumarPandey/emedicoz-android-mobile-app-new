...
public class RelatedCourseComment {
    ...
    @SerializedName("data")
    @Expose
    private RelatedCourseCommentData data;
    ...
    public RelatedCourseCommentData getData() {
        return data;
    }

    public void setData(RelatedCourseCommentData data) {
        this.data = data;
    }
