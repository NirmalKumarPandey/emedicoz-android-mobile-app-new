...
public class User implements Serializable {
    ...
    private String is_add_podcast;
    private String u_c_id;
    ...
    public String getIs_add_podcast() {
        return is_add_podcast;
    }

    public void setIs_add_podcast(String is_add_podcast) {
        this.is_add_podcast = is_add_podcast;
    }

    public TextMessage getText_message() {
        return textmessage;
    }

    public String getU_c_id() {
        return u_c_id;
    }

    public void setU_c_id(String u_c_id) {
        this.u_c_id = u_c_id;
    }
    ...
    public String getU_ct_id() {
        return u_ct_id;
    }

    public void setU_ct_id(String u_ct_id) {
        this.u_ct_id = u_ct_id;
    }

    public void setText_message(TextMessage text_message) {
    ...
    public String toString() {
        return "User{" +
                ...
                ", gender='" + gender + '\'' +
                ", is_social='" + is_social + '\'' +
                ", is_course_register='" + is_course_register + '\'' +
                ", profile_picture='" + profile_picture + '\'' +
                ", social_type='" + social_type + '\'' +
                ", device_tokken='" + device_tokken + '\'' +
                ", password='" + password + '\'' +
                ", expert_following=" + expert_following +
                ", mobile='" + mobile + '\'' +
                ", c_code='" + c_code + '\'' +
                ", dams_tokken='" + dams_tokken + '\'' +
