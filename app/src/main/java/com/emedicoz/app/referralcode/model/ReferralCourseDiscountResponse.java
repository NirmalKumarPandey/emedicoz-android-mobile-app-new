...
public class ReferralCourseDiscountResponse {
    ...
    @SerializedName("data")
    @Expose
    private CourseDiscountAmtData data;
    ...
    public CourseDiscountAmtData getData() {
        return data;
    }

    public void setData(CourseDiscountAmtData data) {
        this.data = data;
    }
