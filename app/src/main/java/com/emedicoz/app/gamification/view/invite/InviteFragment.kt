...
import com.emedicoz.app.databinding.InviteFragmentBinding

class InviteFragment : Fragment(), View.OnClickListener {
    private var _binding: InviteFragmentBinding? = null
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val onBackPressedCallback = object : OnBackPressedCallback(true) {
            override fun handleOnBackPressed() {
                findNavController().navigate(R.id.action_InviteFragment_to_SubjectFragment)
            }
        }
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        _binding = InviteFragmentBinding.inflate(inflater, container, false)
        return binding.root
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.rvPlayer.adapter = inviteAdapter
    }
