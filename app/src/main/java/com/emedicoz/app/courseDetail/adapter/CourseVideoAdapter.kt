...
class CourseVideoAdapter(private val context: Context, private val courseList: ArrayList<TopicVideoDatum>, private val courseId: String)
    ...
    override fun getGroupView(groupPosition: Int, isExpanded: Boolean, convertView: View?, parent: ViewGroup): View {
        ...
        if (courseList[groupPosition].totalVideos.toInt() == 0) {
            courseList[groupPosition].totalDuration = "0"
        }
        binding.moduleDetails.text = courseList[groupPosition].totalVideos.toString() + " Videos-" + courseList[groupPosition].totalDuration + " mins"
        ...
        val childArray: ArrayList<ListDetailData> = courseList[groupPosition].list

        if (childArray == null || childArray.size <= 0) {
            binding.imgExpanded.visibility = View.INVISIBLE
        }
    ...
    override fun getChildView(groupPosition: Int, childPosition: Int, isLastChild: Boolean, convertView: View?, parent: ViewGroup?): View {
        ...
        binding.expandSecond.apply {
            setAdapter(CourseVideoSubAdapter(context, courseList[groupPosition].id, childArray, courseId))
