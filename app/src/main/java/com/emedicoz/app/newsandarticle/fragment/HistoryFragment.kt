...
import com.emedicoz.app.databinding.FragmentHistoryBinding
...
class HistoryFragment : Fragment() , ProgressUpdateListner {
    ...
    override fun onCreateView( inflater: LayoutInflater, container: ViewGroup?,  savedInstanceState: Bundle?): View?
    {
        ...
        mNewsAndArticleViewModel.loadNewsList(context,this , SharedPreference.getInstance().getLoggedInUser().getId(),"history" )
