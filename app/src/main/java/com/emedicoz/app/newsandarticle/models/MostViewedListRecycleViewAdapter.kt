...
import com.emedicoz.app.databinding.NewsArticleMostviewedRowBinding
...
class MostViewedListRecycleViewAdapter(private val context: Context, var mNewsList: List<NewsDetail.Article>) : RecyclerView.Adapter<RecyclerView.ViewHolder>() {

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {

        val binding = NewsArticleMostviewedRowBinding.inflate(LayoutInflater.from(parent.context), parent, false)
...
*/
    ...
    inner class NewsArticleRowViewHolder(val mNewsArticleRowBinding: NewsArticleMostviewedRowBinding)
