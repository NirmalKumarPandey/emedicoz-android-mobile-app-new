 ...
 * Use the [NewsArticleDetailFragment.newInstance] factory method to
...
class NewsArticleDetailFragment : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment NewsArticleDetailFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
                NewsArticleDetailFragment().apply {
