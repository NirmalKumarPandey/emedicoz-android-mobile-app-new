...
import com.emedicoz.app.databinding.FragmentTrendingBinding
...
class TrendingFragment : Fragment() , ProgressUpdateListner {
    ...
    ): View?
    {
        ...
        mNewsAndArticleViewModel.loadNewsList(context,this , SharedPreference.getInstance().getLoggedInUser().getId(),"trending" )
        return root
    }
