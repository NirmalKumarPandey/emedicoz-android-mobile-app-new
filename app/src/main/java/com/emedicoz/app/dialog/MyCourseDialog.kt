...
class MyCourseDialog: BottomSheetDialogFragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        imageView7.setOnClickListener(View.OnClickListener {
            SharedPreference.getInstance().saveMyCourseStatus(Const.MY_COURSE_RATING, "")
            dismiss()
        })
        ...
        rating = 0f
        course_id = SharedPreference.getInstance().getMyCourseId(Const.MY_COURSE_ID, "")
        type = Constants.TestType.APP_COURSE
...
//                } else {
//                    saveRatingAll(SharedPreference.getInstance().loggedInUser.id, course_id, rating, editFeedback.text.toString(), type)
//                }
