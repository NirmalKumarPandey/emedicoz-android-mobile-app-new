...
import com.emedicoz.app.databinding.RecordCoursesListItemCourseAsPerSearchBinding
...
class RecordedCourseAsPerSearchItemAdapter(private var courseAsSearchList: ArrayList<Course>, private val context: Context)
    : SliderViewAdapter<RecordedCourseAsPerSearchItemAdapter.RecordedCourseAsSearchViewHolder>() {

    private lateinit var progress: Progress

    override fun onBindViewHolder(holder: RecordedCourseAsSearchViewHolder, position: Int) {
        val currentCourseItem: Course = courseAsSearchList[position]
    ...
    override fun onCreateViewHolder(parent: ViewGroup): RecordedCourseAsSearchViewHolder {
        val binding = RecordCoursesListItemCourseAsPerSearchBinding
                .inflate(LayoutInflater.from(parent.context), parent, false)
        return RecordedCourseAsSearchViewHolder(binding)
    }

    inner class RecordedCourseAsSearchViewHolder(val binding: RecordCoursesListItemCourseAsPerSearchBinding)
        : SliderViewAdapter.ViewHolder(binding.root)

    override fun getCount() = courseAsSearchList.size
